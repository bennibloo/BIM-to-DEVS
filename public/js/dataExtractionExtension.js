...
class DataExtractExtension extends Autodesk.Viewing.Extension {
    ...
    /**
     * Method to get the bounding box of an element
     * @param {*} model 
     * @param {*} dbid 
     * @returns 
     * 
     * source: https://stackoverflow.com/questions/70797393/how-to-find-all-the-rooms-inside-a-space-or-zone-in-autodesk-forge-viewer
     */
